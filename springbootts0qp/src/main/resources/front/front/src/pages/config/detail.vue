		...
		<div class="attr" :style='{"padding":"20px","position":"relative","flexDirection":"column","display":"flex"}'>
			...
			<div class="info" :style='{"width":"100%","padding":"10px","margin":"20px 0 0 10px","background":"#F5F5F5","order":"4"}'>
				...
				<div class="item" :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#ffff","display":"inline-block"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#999","textAlign":"center","display":"inline-block","width":"110px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>名称</div>
					<div  :style='{"padding":"0 10px","color":"#666","display":"inline-block","width":"calc(100% - 110px)","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.name}}</div>
				</div>
