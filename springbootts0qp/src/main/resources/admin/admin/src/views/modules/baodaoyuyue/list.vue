		...
		<template v-if="showFlag">
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' v-if="isAuth('baodaoyuyue','审核')" prop="sfsh" label="审核">
						<template slot-scope="scope">
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          baodaoshijian: row.baodaoshijian,
          laiwangfangshi: row.laiwangfangshi,
          sushehao: row.sushehao,
          chuangweihao: row.chuangweihao,
          baodaoshuoming: row.baodaoshuoming,
          xuehao: row.xuehao,
