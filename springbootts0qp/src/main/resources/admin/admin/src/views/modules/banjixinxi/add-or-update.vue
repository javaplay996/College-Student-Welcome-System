<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="班级名称" prop="banjimingcheng">
					<el-input v-model="ruleForm.banjimingcheng" placeholder="班级名称" clearable  :readonly="ro.banjimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="班级名称" prop="banjimingcheng">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="辅导员" prop="fudaoyuan">
					<el-input v-model="ruleForm.fudaoyuan" placeholder="辅导员" clearable  :readonly="ro.fudaoyuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="辅导员" prop="fudaoyuan">
					<el-input v-model="ruleForm.fudaoyuan" placeholder="辅导员" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="指导老师" prop="zhidaolaoshi">
					<el-input v-model="ruleForm.zhidaolaoshi" placeholder="指导老师" clearable  :readonly="ro.zhidaolaoshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="指导老师" prop="zhidaolaoshi">
					<el-input v-model="ruleForm.zhidaolaoshi" placeholder="指导老师" readonly></el-input>
				</el-form-item>
			</template>
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='fudaoyuan'){
							...
							this.ro.fudaoyuan = true;
							continue;
						}
						if(o=='zhidaolaoshi'){
							this.ruleForm.zhidaolaoshi = obj[o];
							this.ro.zhidaolaoshi = true;
							continue;
						}
				}
