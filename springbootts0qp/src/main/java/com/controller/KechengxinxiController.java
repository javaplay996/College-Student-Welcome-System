        ...
        try {
            ...
            if(rows>1){
                ...
                for (int i = 1; i < rows; i++) {
                    ...
                    kechengxinxiEntity.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
                    String banji = CommonUtil.getCellValue(row.getCell(0));
                    kechengxinxiEntity.setBanji(banji);
                    String kechengyi = CommonUtil.getCellValue(row.getCell(1));
                    kechengxinxiEntity.setKechengyi(kechengyi);
                    String kechenger = CommonUtil.getCellValue(row.getCell(2));
                    kechengxinxiEntity.setKechenger(kechenger);
                    String kechengsan = CommonUtil.getCellValue(row.getCell(3));
                    kechengxinxiEntity.setKechengsan(kechengsan);
                    String kechengsi = CommonUtil.getCellValue(row.getCell(4));
                    kechengxinxiEntity.setKechengsi(kechengsi);
                    String kechengwu = CommonUtil.getCellValue(row.getCell(5));
                    kechengxinxiEntity.setKechengwu(kechengwu);
                    String kechengliu = CommonUtil.getCellValue(row.getCell(6));
                    kechengxinxiEntity.setKechengliu(kechengliu);
